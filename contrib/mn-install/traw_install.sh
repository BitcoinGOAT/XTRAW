...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='xtraw.conf'
CONFIGFOLDER='/root/.xtraw'
COIN_DAEMON='xtrawd'
COIN_CLI='xtraw-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BitcoinGOAT/XTrawNetwork/releases/download/1.0.0.1/xtrawd-ubuntu-16.04-x64.tar.gz'
