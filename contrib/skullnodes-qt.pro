...
RESOURCES += src/qt/xtraw.qrc src/qt/xtraw_locale.qrc

TRANSLATIONS += src/qt/locale/xtraw_bg.ts \
                src/qt/locale/xtraw_de.ts \
                src/qt/locale/xtraw_en.ts \
                src/qt/locale/xtraw_es.ts \
                src/qt/locale/xtraw_fi.ts \
                src/qt/locale/xtraw_fr.ts \
                src/qt/locale/xtraw_it.ts \
                src/qt/locale/xtraw_ja.ts \
                src/qt/locale/xtraw_pl.ts \
                src/qt/locale/xtraw_pt.ts \
                src/qt/locale/xtraw_ru.ts \
                src/qt/locale/xtraw_sk.ts \
                src/qt/locale/xtraw_sv.ts \
                src/qt/locale/xtraw_vi.ts \
                src/qt/locale/xtraw_zh_CN.ts \
                src/qt/locale/xtraw_zh_TW.ts
