...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "gextrawmempool", &gextrawmempool, true, false, false},
        ...
        {"rawtransactions", "gextrawtransaction", &gextrawtransaction, true, false, false},
        ...
        /* xtraw features */
        {"xtraw", "masternode", &masternode, true, true, false},
        {"xtraw", "listmasternodes", &listmasternodes, true, true, false},
        {"xtraw", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xtraw", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xtraw", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xtraw", "masternodedebug", &masternodedebug, true, true, false},
        {"xtraw", "startmasternode", &startmasternode, true, true, false},
        {"xtraw", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xtraw", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xtraw", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xtraw", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xtraw", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xtraw", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xtraw", "mnbudget", &mnbudget, true, true, false},
        {"xtraw", "preparebudget", &preparebudget, true, true, false},
        {"xtraw", "submitbudget", &submitbudget, true, true, false},
        {"xtraw", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xtraw", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xtraw", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xtraw", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xtraw", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xtraw", "mnbudgextrawvote", &mnbudgextrawvote, true, true, false},
        {"xtraw", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xtraw", "checkbudgets", &checkbudgets, true, true, false},
        {"xtraw", "mnsync", &mnsync, true, true, false},
        {"xtraw", "spork", &spork, true, true, false},
        {"xtraw", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"xtraw", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
        ...
        {"wallet", "gextrawchangeaddress", &gextrawchangeaddress, true, false, true},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xtrawd, or the -server option to xtraw-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xtraw-cli " + methodname + " " + args + "\n";
}
