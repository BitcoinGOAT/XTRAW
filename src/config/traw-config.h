/* src/config/xtraw-config.h.  Generated from xtraw-config.h.in by configure.  */
/* src/config/xtraw-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef XTRAW_CONFIG_H

#define XTRAW_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.xtraw.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "XTraw Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XTraw Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xtraw"
