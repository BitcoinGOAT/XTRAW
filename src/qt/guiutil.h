...
/** Utility functions used by the XTraw Qt UI.
 */
namespace GUIUtil
{
...
// Render XTraw addresses in monospace font
...
// Parse "xtraw:" URI into recipient object, return true on successful parsing
