...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SEND:
        return QString("XTRAW");
    case mSEND:
        return QString("mXTRAW");
    case uSEND:
        return QString::fromUtf8("uXTRAW");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mSEND:
            return QString("mXTRAW");
        case uSEND:
            return QString::fromUtf8("μXTRAW");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SEND:
            return QString("tXTRAW");
        case mSEND:
            return QString("mtXTRAW");
        case uSEND:
            return QString::fromUtf8("μtXTRAW");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SEND:
            return QString("XTRAW");
        case mSEND:
            return QString("Milli-XTRAW (1 / 1" THIN_SP_UTF8 "000)");
        case uSEND:
            return QString("Micro-XTRAW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        ...
        case uSEND:
            return QString("Micro-TestXTRAW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
