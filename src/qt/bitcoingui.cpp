                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XTraw Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XTRAW address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XTraw Core"), this);
    aboutAction->setStatusTip(tr("Show information about XTraw Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XTraw"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XTRAW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XTRAW addresses"));
    ...
    openAction->setStatusTip(tr("Open a XTraw: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XTraw Core help message to get a list with possible XTraw command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XTraw Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XTraw network", "", count));
}
...
{
    QString strTitle = tr("XTraw Core"); // default title
