...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    BOOST_CHECK_THROW(CallRPC("gextrawtransaction"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("gextrawtransaction not_hex"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("gextrawtransaction a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed not_int"), runtime_error);
